...
public abstract class SquareComponent extends JComponent {
    ...
    protected SquareComponent(ChessboardPoint chessboardPoint, Point location, ChessColor chessColor,
    ...
    static boolean lastCheatMode = false;
    ...
    public boolean canMoveTo(SquareComponent[][] chessboard, ChessboardPoint destination) {
        ...
        for (int i = 0; i < dx.length; i++) {
            if (this.chessboardPoint.getX() + dx[i] == destination.getX()
                    && this.chessboardPoint.getY() + dy[i] == destination.getY())
                flag = true;
        }
        if (flag) {
            ...
            if (destinationChess.isReversal) {
                if (this.getType() == 6) {
                    return destinationChess.getType() == 1 || destinationChess.getType() == 6;
                } else if (this.getType() == 1) {
                    return this.getType() < destinationChess.getType() && destinationChess.getType() != 6;
                } else {
                    return this.getType() <= destinationChess.getType();
                }
            } else {
                return false;
            }
